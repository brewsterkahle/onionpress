...
1. Download `onion.press.dmg` from the [releases page](https://github.com/brewsterkahle/onion.press/releases)
...
onion.press includes both a menu bar app and command-line tool.

### Menu Bar App (Recommended)

Simply launch `onion.press.app` from Applications. The onion icon will appear in your menu bar.
...
```bash
/Applications/onion.press.app/Contents/MacOS/onion.press start
```
...
/Applications/onion.press.app/Contents/MacOS/onion.press address

# Check status
/Applications/onion.press.app/Contents/MacOS/onion.press status

# View logs
/Applications/onion.press.app/Contents/MacOS/onion.press logs

# Stop the service
/Applications/onion.press.app/Contents/MacOS/onion.press stop
```
...
```bash
alias onion-press="/Applications/onion.press.app/Contents/MacOS/onion.press"
```
...
Want a different prefix? Edit `~/.onion.press/config` before first launch:
```bash
...
- Check logs: `/Applications/onion.press.app/Contents/MacOS/onion.press logs`
- View documentation: See README.md
- Report issues: [GitHub issues page](https://github.com/brewsterkahle/onion.press/issues)
